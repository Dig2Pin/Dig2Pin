...
import { w as walkSlateNode } from './slate-walker-681d1a7f.esm.js';
...
class Content extends Relationship.implementation {
  constructor(path, _ref, listConfig) {
    ...
    const type = `${GQL_TYPE_PREFIX}_${itemQueryName}_${path}`; // Normalise blocks to always be a tuple with a config object
