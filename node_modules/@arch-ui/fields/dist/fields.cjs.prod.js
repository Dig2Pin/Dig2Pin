...
var _objectWithoutProperties = _interopDefault(require("@babel/runtime/helpers/objectWithoutProperties")), _extends = _interopDefault(require("@babel/runtime/helpers/extends")), core = require("@emotion/core"), theme = require("@arch-ui/theme"), icons = require("@arch-ui/icons"), lozenge = require("@arch-ui/lozenge");
...
}, FieldDescription = _ref => {
  let {text: text} = _ref, props = _objectWithoutProperties(_ref, [ "text" ]);
...
}, FieldInput = props => core.jsx("div", _extends({
  css: {
    display: "flex"
  }
