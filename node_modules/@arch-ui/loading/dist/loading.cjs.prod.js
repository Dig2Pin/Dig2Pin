...
const fadeAnim = core.keyframes(_templateObject()), appearanceColor = {
  ...
  verticalAlign: "top",
  width: "1em"
})), LoadingIndicator = ({appearance: appearance = "default", size: size = 4}) => React.createElement(DotsContainer, {
  size: size
  ...
  delay: 320,
  isOffset: !0
}), React.createElement(typography.A11yText, null, "Loading")), spinAnim = core.keyframes(_templateObject2()), spinnerCommon = ({size: size}) => ({
  borderRadius: "50%",
  borderStyle: "solid",
  borderWidth: size / 8,
