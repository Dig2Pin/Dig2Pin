...
const unpackOptions = (options = {}) => _objectSpread(_objectSpread({
  plugins: []
}, options), {}, {
...
let rollupPluginBabel = pluginOptions => {
  ...
  const includeExcludeFilter = (0, _pluginutils.createFilter)(include, exclude);
  ...
  return {
    ...
    transform(code, filename) {
      ...
      let options = JSON.stringify(_objectSpread(_objectSpread({}, babelOptions), {}, {
        filename
      }));
